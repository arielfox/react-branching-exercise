export const questions = [
    ...
    {id: 5, text: "You don't have time to cook anything.", breadcrumb: "5 min", options: []},
    {id: 6, text: "Here's your sandwich", breadcrumb: "", options: []},
    {id: 7, text: "Here's your salad", breadcrumb: "", options: []},
    {id: 8, text: "Here's your pasta", breadcrumb: "", options: []},
    ...
    {id: 11, text: "Enjoy fish tacos from Cholita Linda", breadcrumb: "Cholita Linda", options: []},
    {id: 12, text: "Grab a vegan huarache and taquitos from Flacos", breadcrumb: "Flacos", options: []},
    {id: 13, text: "Order ceviche and the tamal de verduras from Tacubaya", breadcrumb: "Tacubaya", options: []},
    ...
    {id: 15, text: "Sooth yourself with a steaming hot bowl of pho from Monster Pho", breadcrumb: "Monster Pho", options: []},
    {id: 16, text: "A claypot or vermicelli from Mint Leaf", breadcrumb: "Mint Leaf", options: []},
    {id: 17, text: "Crispy pumpkin and pad see ew coming right up from Imm Thai Street Food", breadcrumb: "Imm Thai", options: []},
    {id: 18, text: "Curry roti and rice ball salad from Chai Thai Noodles", breadcrumb: "Chai Thai", options: []},
    {id: 19, text: "Get the mezze platter from Lulu", breadcrumb: "Lulu", options: []},
    {id: 20, text: "Crispy tofu and green papaya salad from Funky Elephant Thai", breadcrumb: "Funky Elephant", options: []},
    {id: 21, text: "Sit outside under the tent and with the crispiest chips at Picante", breadcrumb: "Picante", options: []},
    {id: 22, text: "Homemade veggie dumplings and soup from Pho Le", breadcrumb: "Pho Le", options: []},
    ...
    {id: 24, text: "Freshest salmon and yellowtail around at Kiku Sushi", breadcrumb: "Kiku Sushi", options: []},
    {id: 25, text: "Housemade beet veggie burger at Eureka!", breadcrumb: "Eureka!", options: []},
    {id: 26, text: "Seasonal banchan and freshly made tofu from Joodooboo", breadcrumb: "Joodooboo", options: []},
    {id: 27, text: "Spinach feta bourek, eggplant dolma, and honeycake from Simurgh Bakery & Cafe", breadcrumb: "Simurgh", options: []},
];
